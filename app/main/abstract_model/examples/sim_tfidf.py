...
sys.path.append('../src')
from ..src import data_io, sim_algo, eval, params

## run
wordfiles = [
    # '../data/paragram_sl999_small.txt', # need to download it from John Wieting's github (https://github.com/jwieting/iclr2016)
